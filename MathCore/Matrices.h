...
namespace Geometry
{
    ...
    public:
        ...
        void        setRow(int index, const OdGeVector2d& v);
        void        setColumn(int index, const float col[2]);
        void        setColumn(int index, const OdGeVector2d& v);
        ...
        Matrix2& operator-=(const Matrix2& rhs);
        OdGeVector2d     operator*(const OdGeVector2d& rhs) const;
        Matrix2     operator*(const Matrix2& rhs) const;
        Matrix2& operator*=(const Matrix2& rhs);
        ...
        friend OdGeVector2d operator*(const OdGeVector2d& vec, const Matrix2& m); // pre-multiplication
    ...
    public:
        ...
        void        setRow(int index, const OdGeVector3d& v);
        void        setColumn(int index, const float col[3]);
        void        setColumn(int index, const OdGeVector3d& v);

        const float* get() const;
        float       getDeterminant() const;
        OdGeVector3d     getAngle() const;                       // return (pitch, yaw, roll)
        ...
        OdGeVector3d     operator*(const OdGeVector3d& rhs) const;    // multiplication: v' = M * v
        ...
        friend OdGeVector3d operator*(const OdGeVector3d& vec, const Matrix3& m); // pre-multiplication
    ...
    public:
        ...
        void        setRow(int index, const OdGeVector4d& v);
        void        setRow(int index, const OdGeVector3d& v);
        void        setColumn(int index, const float col[4]);
        void        setColumn(int index, const OdGeVector4d& v);
        void        setColumn(int index, const OdGeVector3d& v);
        ...
        Matrix4& translate(const OdGeVector3d& v);            //
        Matrix4& rotate(float angle, const OdGeVector3d& axis); // rotate angle(degree) along the given axix
        ...
        Matrix4& lookAt(const OdGeVector3d& target);
        Matrix4& lookAt(const OdGeVector3d& target, const OdGeVector3d& up);
        //@@Matrix4&    skew(float angle, const OdGeVector3d& axis); //
        ...
        OdGeVector4d     operator*(const OdGeVector4d& rhs) const;    // multiplication: v' = M * v
        OdGeVector3d     operator*(const OdGeVector3d& rhs) const;    // multiplication: v' = M * v
        ...
        friend OdGeVector3d operator*(const OdGeVector3d& vec, const Matrix4& m); // pre-multiplication
        friend OdGeVector4d operator*(const OdGeVector4d& vec, const Matrix4& m); // pre-multiplication
    ...
    inline void Matrix2::setRow(int index, const OdGeVector2d& v)
    {
    ...
    inline void Matrix2::setColumn(int index, const OdGeVector2d& v)
    {
    ...
    inline OdGeVector2d Matrix2::operator*(const OdGeVector2d& rhs) const
    {
        return OdGeVector2d(m[0] * rhs.x + m[2] * rhs.y, m[1] * rhs.x + m[3] * rhs.y);
    }
    ...
    inline OdGeVector2d operator*(const OdGeVector2d& v, const Matrix2& rhs)
    {
        return OdGeVector2d(v.x * rhs[0] + v.y * rhs[1], v.x * rhs[2] + v.y * rhs[3]);
    }
    ...
    inline void Matrix3::setRow(int index, const OdGeVector3d& v)
    {
    ...
    inline void Matrix3::setColumn(int index, const OdGeVector3d& v)
    {
    ...
    inline OdGeVector3d Matrix3::operator*(const OdGeVector3d& rhs) const
    {
        return OdGeVector3d(m[0] * rhs.x + m[3] * rhs.y + m[6] * rhs.z,
    ...
    inline OdGeVector3d operator*(const OdGeVector3d& v, const Matrix3& m)
    {
        return OdGeVector3d(v.x * m[0] + v.y * m[1] + v.z * m[2], v.x * m[3] + v.y * m[4] + v.z * m[5], v.x * m[6] + v.y * m[7] + v.z * m[8]);
    }
    ...
    inline void Matrix4::setRow(int index, const OdGeVector4d& v)
    {
        m[index] = v.x;  m[index + 4] = v.y;  m[index + 8] = v.z;  m[index + 12] = v.w;
    }

    inline void Matrix4::setRow(int index, const OdGeVector3d& v)
    {
    ...
    inline void Matrix4::setColumn(int index, const OdGeVector4d& v)
    {
        m[index * 4] = v.x;  m[index * 4 + 1] = v.y;  m[index * 4 + 2] = v.z;  m[index * 4 + 3] = v.w;
    }

    inline void Matrix4::setColumn(int index, const OdGeVector3d& v)
    {
    ...
    inline OdGeVector4d Matrix4::operator*(const OdGeVector4d& rhs) const
    {
        return OdGeVector4d(m[0] * rhs.x + m[4] * rhs.y + m[8] * rhs.z + m[12] * rhs.w,
            m[1] * rhs.x + m[5] * rhs.y + m[9] * rhs.z + m[13] * rhs.w,
            m[2] * rhs.x + m[6] * rhs.y + m[10] * rhs.z + m[14] * rhs.w,
            m[3] * rhs.x + m[7] * rhs.y + m[11] * rhs.z + m[15] * rhs.w);
    }

    inline OdGeVector3d Matrix4::operator*(const OdGeVector3d& rhs) const
    {
        return OdGeVector3d(m[0] * rhs.x + m[4] * rhs.y + m[8] * rhs.z + m[12],
    ...
    inline OdGeVector4d operator*(const OdGeVector4d& v, const Matrix4& m)
    {
        return OdGeVector4d(v.x * m[0] + v.y * m[1] + v.z * m[2] + v.w * m[3], v.x * m[4] + v.y * m[5] + v.z * m[6] + v.w * m[7], v.x * m[8] + v.y * m[9] + v.z * m[10] + v.w * m[11], v.x * m[12] + v.y * m[13] + v.z * m[14] + v.w * m[15]);
    }

    inline OdGeVector3d operator*(const OdGeVector3d& v, const Matrix4& m)
    {
        return OdGeVector3d(v.x * m[0] + v.y * m[1] + v.z * m[2], v.x * m[4] + v.y * m[5] + v.z * m[6], v.x * m[8] + v.y * m[9] + v.z * m[10]);
    }
